...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $brands = [
            ['name' => 'Aurent', 'slug' => 'aurent', 'description' => 'House brand of contemporary haute horology.'],
            ['name' => 'Maison Tempête', 'slug' => 'maison-tempete', 'description' => 'Independent Swiss workshops.'],
        ];
        ...
        $categories = [
            ['name' => 'Dress Watches', 'slug' => 'dress-watches', 'description' => 'Elegant timepieces for formal occasions.'],
            ['name' => 'Sport Watches', 'slug' => 'sport-watches', 'description' => 'Robust watches built for performance.'],
        ];
        ...
        $watches = [
            ...
            [
                'brand' => 'aurent', 'category' => 'sport-watches', 'gender' => 'UNISEX',
                'name' => 'Aurent Diver', 'sku' => 'AUR-DV-002',
                'price' => 3200, 'stock' => 12,
                'movement' => 'Automatic', 'case_material' => 'Titanium', 'case_diameter' => '42mm',
                'dial' => 'Matte Black', 'crystal' => 'Sapphire', 'water_resistance' => '300m', 'strap' => 'Titanium Bracelet', 'warranty' => '5 years',
                'best_seller' => true,
            ],
            [
                'brand' => 'aurent', 'category' => 'dress-watches', 'gender' => 'WOMEN',
                'name' => 'Aurent Petite', 'sku' => 'AUR-PT-003',
                'price' => 1850, 'stock' => 6,
            ...
            [
                'brand' => 'maison-tempete', 'category' => 'dress-watches', 'gender' => 'MEN',
                'name' => 'Maison Tempête Royale', 'sku' => 'MT-ROY-001',
                'price' => 5800, 'stock' => 4,
                'movement' => 'Hand-wound', 'case_material' => '18k White Gold', 'case_diameter' => '38mm',
                'dial' => 'Grand Feu Enamel', 'crystal' => 'Sapphire', 'water_resistance' => '30m', 'strap' => 'Hand-stitched Calf', 'warranty' => '10 years',
                'featured' => true,
            ],
            [
                'brand' => 'maison-tempete', 'category' => 'sport-watches', 'gender' => 'MEN',
                'name' => 'Maison Tempête Alpine', 'sku' => 'MT-ALP-002',
                'price' => 4100, 'stock' => 7,
                'movement' => 'Automatic', 'case_material' => 'Grade 5 Titanium', 'case_diameter' => '41mm',
                'dial' => 'Glacier Blue', 'crystal' => 'Sapphire', 'water_resistance' => '200m', 'strap' => 'Rubber Strap', 'warranty' => '8 years',
                'best_seller' => true,
            ],
            [
                'brand' => 'aurent', 'category' => 'dress-watches', 'gender' => 'MEN',
                'name' => 'Aurent Chronograph', 'sku' => 'AUR-CH-004',
                'price' => 3900, 'stock' => 5,
        ...
        BlogPost::create([
            ...
            'slug' => 'first-luxury-watch',
            'excerpt' => 'A guide for new collectors entering the world of haute horology.',
            'content' => '<p>Buying your first luxury watch is an exciting milestone. Focus on movements, materials, and the heritage of the brand before committing to a purchase.</p>',
            'featured_image' => null,
        ...
        BlogPost::create([
            'title' => 'The Craft of Sapphire Crystals',
            'slug' => 'sapphire-crystals',
            'excerpt' => 'Why sapphire dominates the luxury watch crystal market.',
            'content' => '<p>Sapphire crystal is prized for its scratch resistance and clarity. Most high-end timepieces use synthetic sapphire for the best durability.</p>',
            'featured_image' => null,
